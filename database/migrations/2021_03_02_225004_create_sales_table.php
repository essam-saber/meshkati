...
class CreateSalesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sales', function (Blueprint $table) {
            ...
            $table->decimal('g_profit')->default(0.00);
            $table->decimal('g_profit_cum')->default(0.00);
            $table->decimal('g_profit_percentage')->nullable();
            $table->decimal('g_profit_cum_percentage')->nullable();
