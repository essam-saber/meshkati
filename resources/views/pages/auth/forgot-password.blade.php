...
<head><base href="../../../../">
    <meta charset="utf-8" />
    <title>Forgot Password | Meshkati</title>
        ...
        <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url({{asset('media/bg/bg-2.jpg')}});">
            <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                ...
                <div class="d-flex flex-center mb-15">
                    <a href="#">
                        <img src="{{asset('media/logos/meshkati.jpg')}}" class="max-h-75px" alt="" />
                    </a>
                </div>
                <!--end::Login Header-->
                ...
                <div class="login-signin">
                    <div class="mb-20">
                        ...
                        <p class="opacity-40">Enter your email</p>
                    </div>
                    <form class="form" id="" method="POST" action="{{route('password.email')}}">
                        @csrf
                        @method('post')
