...
@section('content')
    ...
    <div class="card card-custom gutter-b example example-compact">
        ...
        <!--begin::Form-->
        <form class="form" method="post" action="{{route('aging-of-debit.store')}}">
            @csrf()
            <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="input-group">
                                <input type="number" required name="attributes[{{$attribute->id}}]" min="0" value="0" step=".01" class="form-control" aria-label="Amount (to the nearest SAR)">
