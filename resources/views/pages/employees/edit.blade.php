                ...
                <form class="form" method="post" action="{{route('employees.update', $employee->id)}}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid {{$errors->has('name') ? 'is-invalid': ''}}" value="{{$employee->name}}" name="name" placeholder="Enter employee name"/>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control form-control-solid {{$errors->has('email') ? 'is-invalid': ''}}" name="email" value="{{$employee->email}}" placeholder="Enter employee name"/>
                            @if($errors->has('email'))
