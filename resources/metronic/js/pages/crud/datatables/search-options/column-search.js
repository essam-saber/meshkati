            ...
            initComplete: function() {
                ...
                this.api().columns().every(function() {
                    ...
                    switch (column.title()) {
                        ...
                        case 'Ship City':
                        case 'Company Agent':
                            input = $(`<input type="text" class="form-control form-control-sm form-filter datatable-input" data-col-index="` + column.server() + `"/>`);
                            break;

                        case 'Country':
                            input = $(`<select class="form-control form-control-sm form-filter datatable-input" title="Select" data-col-index="` + column.server() + `">
                ...
                var hideSearchColumnResponsive = function() {
                    thisTable.api().columns().every(function() {
                        ...
                        if (column.responsiveHidden()) {
                            $(rowFilter).find('th').eq(column.server()).show();
                        } else {
                            $(rowFilter).find('th').eq(column.server()).hide();
                        }
                    })
                };
